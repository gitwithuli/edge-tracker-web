  ...
  return (
    <>
      ...
      <div className="min-h-screen flex">
        ...
        <div className="flex-1 bg-[#FAF7F2] dark:bg-[#1a1a1a] flex items-center justify-center p-6 sm:p-12 relative">
          {/* Theme Toggle */}
          ...
          <div className="w-full max-w-md">
            ...
            >
              ...
              <p className="text-[#0F0F0F]/50 dark:text-white/50">
                {isSignUp ? 'Create an account to start tracking your edge' : 'Sign in to continue tracking your edge'}
              </p>
            </div>
            ...
            <div
              className={`mt-8 text-center opacity-0 ${mounted ? 'animate-fade-in' : ''}`}
              style={{ animationDelay: '0.6s' }}
            >
              <p className="text-sm text-[#0F0F0F]/50 dark:text-white/50">
                ...
                <button
                  ...
                  className="text-[#C45A3B] hover:underline font-medium"
                >
