    ...
    <>
      ...
      <div className="min-h-screen bg-[#FAF7F2] dark:bg-[#0F0F0F] text-[#0F0F0F] dark:text-white selection:bg-[#C45A3B]/20 overflow-hidden relative transition-colors duration-300">
        ...
        <main className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-16 lg:pt-24 pb-16 sm:pb-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <a
                href="/login"
                className="inline-flex items-center justify-center gap-2 bg-[#0F0F0F] dark:bg-white text-[#FAF7F2] dark:text-[#0F0F0F] px-8 py-4 rounded-full text-sm font-medium hover:bg-[#C45A3B] dark:hover:bg-[#C45A3B] dark:hover:text-white transition-colors duration-500"
              >
                Get Started
                <ArrowRight className="w-4 h-4" />
              </a>
              <p className="mt-4 text-xs text-[#0F0F0F]/50 dark:text-white/50">
          ...
          >
            <p className="text-center text-[10px] sm:text-xs tracking-[0.3em] uppercase text-[#0F0F0F]/50 dark:text-white/50 mb-10 sm:mb-14">
              Features
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                <div
                  key={feature.title}
                  className="group p-6 sm:p-8 rounded-2xl bg-white/50 dark:bg-white/[0.02] border border-[#0F0F0F]/5 dark:border-white/5 hover:border-[#0F0F0F]/10 dark:hover:border-white/10 hover:bg-white dark:hover:bg-white/[0.04] transition-colors duration-500"
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#0F0F0F]/5 dark:bg-white/5 flex items-center justify-center mb-5 group-hover:bg-[#C45A3B]/10 dark:group-hover:bg-[#C45A3B]/20 transition-colors duration-500">
                    <feature.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#0F0F0F]/50 dark:text-white/50 group-hover:text-[#C45A3B] transition-colors duration-500" />
                  </div>
                  <h3
        ...
        <footer className="relative z-10 border-t border-[#0F0F0F]/5 dark:border-white/5 py-6 sm:py-8">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-[#0F0F0F]/50 dark:text-white/50">
